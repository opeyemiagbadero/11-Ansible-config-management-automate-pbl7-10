...
18. I updated git with the latest code and used the following git commands  *git status git add <selected file> and git commit -m "commit message" commands to add, comit and push the branch into github
